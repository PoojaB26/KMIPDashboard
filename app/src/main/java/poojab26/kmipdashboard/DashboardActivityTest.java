...
public class DashboardActivityTest extends Activity {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        TableLayout table = new TableLayout(this); //instance
        ...
        day1Conditions.setImageResource(R.drawable.download);
        ...
        day2Conditions.setImageResource(R.drawable.download);
        ...
        day3Conditions.setImageResource(R.drawable.download);
        ...
        day4Conditions.setImageResource(R.drawable.download);
        ...
        day5Conditions.setImageResource(R.drawable.download);
